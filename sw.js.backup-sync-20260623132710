...
const CACHE_NAME = 'divinetouch--v56';
const urlsToCache = [
  '/divinetouch-/',
  '/divinetouch-/index.html',
  '/divinetouch-/admin.html',
  '/divinetouch-/admin-login.html',
  '/divinetouch-/calendar.html',
  '/divinetouch-/setup-wizard.html',
  '/divinetouch-/editar-negocio.html',
  '/divinetouch-/manifest.json',
  '/divinetouch-/icons/icon-72x72.png',
  '/divinetouch-/icons/icon-96x96.png',
  '/divinetouch-/icons/icon-128x128.png',
  '/divinetouch-/icons/icon-144x144.png',
  ...
  '/divinetouch-/utils/push-config.js',
  '/divinetouch-/utils/push-notifications.js'
];
      ...
      .catch(() => {
        ...
        return caches.match(event.request).then(cachedResponse => {
          ...
          if (event.request.url.match(/\.(jpg|jpeg|png|gif|svg|webp)$/)) {
            return caches.match('/divinetouch-/icons/icon-192x192.png');
          }
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/divinetouch-/icons/icon-192x192.png',
    badge: '/divinetouch-/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/divinetouch-/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/divinetouch-/admin.html';
  event.waitUntil(
