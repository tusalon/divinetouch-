    ...
    if (platform === 'ios') {
        return (
            <button
                ...
                className="fixed bottom-6 left-6 z-50 bg-gradient-to-r from-purple-600 to-purple-700 text-white px-6 py-3 rounded-full shadow-2xl hover:from-purple-700 hover:to-pink-700 transition-all transform hover:scale-110 flex items-center gap-3 border-2 border-purple-300"
            ...
            >
                ...
                <div className="text-left">
                    ...
                    <div className="text-xs text-purple-200">iPhone: Compartir → Pantalla inicio</div>
                </div>
            </button>
        );
    }
