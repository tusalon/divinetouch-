            ...
            {loading ? (
                ...
                <>
                    ...
                    {date === getCurrentLocalDate() && (
                        <div className="text-sm text-purple-700 bg-purple-50 p-3 rounded-lg flex items-center gap-2 border border-amber-200">
                            <div className="icon-clock text-purple-600"></div>
                            ...
                            return (
                                <button
                                    ...
                                    className={`
                                        ...
                                        ${isSelected
                                            ? 'bg-gradient-to-r from-purple-600 to-purple-500 text-white shadow-lg scale-105 ring-2 ring-purple-300'
                                            : 'bg-white text-gray-700 border-2 border-purple-200 hover:border-purple-400 hover:bg-purple-50 hover:scale-105 hover:shadow-md'}
                                    `}
                                >
                                    {time12h}
                                </button>
