...
function WhatsAppButton() {
    ...
    return (
        ...
        >
            ...
            <span className="absolute right-full mr-3 bg-gray-800 text-purple-400 px-3 py-1 rounded-lg text-sm font-medium shadow-sm opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none border border-purple-700">
                ¡Agende su turno!
            </span>
        </a>
    );
